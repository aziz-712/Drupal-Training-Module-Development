...
/**
 * @file
 * A form t collect an email address for RSVP details
 */
...
class RSVPForm extends FormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state): array {
    ...
    // Some pages may not be nodes though and $node will be NULL on those page.
    ...
    // Establish the $form redder array. It has an email text field,
    // a submit button, and a hidden field containing the node ID.
    $form['email'] = [
      '#type' => 'textfield',
      '#title' => t('Email address'),
      '#size' => 25,
      '#description' => t('We weill send updates to the email address you provide.'),
      '#required' => TRUE,
    ];
    $form['submit'] = [
      '#type' => 'submit',
...
//      ['@entry' => $submitted_email]));
    try {
      ...
      // Demonstration for how ot load a full user object of the current user.
      // This $full_user variable is not needed for this code,
      // but is shown for demonstration purposes. (to learn)
