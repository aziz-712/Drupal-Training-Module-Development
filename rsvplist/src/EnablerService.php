...
class EnablerService {
   ...
   * @param Node $node
   * @return bool
   *  regardless of whether the node is enabled for the RSVP functionality.
   */
  public function isEnabled(Node $node) {
    ...
    try {
      ...
      \Drupal::messenger()->addError(
        t('Unable ot determine RSVP settings at this time. Please try again.')
      );
      return NULL;
    }
  }
  ...
  public function setEnabled(Node $node) {
    try {
      ...
      \Drupal::messenger()->addError(
        t('Unable to save RSVP settings at this time. Please try agian')
      );
    }
  }
