...
/**
 * @file
 * Provide site adminstrators with a list of all the RSVP List singups
...
class ReportController extends ControllerBase {
  ...
  protected function load() {
    try {
      ...
      // Fetches can be modified by passing in a new fetch node constant.
      // For fetchAll(), it is the first parameter.
      // https://www.durpal.org/docs/8/api/database-api/result-sets
